...
variable "enabled" {
  type        = bool
  description = "Enable or disable the creation of the Virtual Network Gateway."
  default     = false
}
...
variable "vpn_active_active_enabled" {
  type        = bool
  default     = false
  description = "Enable active-active mode for the Virtual Network Gateway. The gateway SKU must be VpnGw1, VpnGw2, VpnGw3 | VpnGw1AZ, VpnGw2AZ, VpnGw3Az"
}
...
#----------------------------------------------
# ExpressRoute Configuration Object Variable
#----------------------------------------------
variable "express_route_config" {
  description = "ExpressRoute configuration object containing all required values"
  type = object({
    vnet_traffic_enable = optional(bool, false)
    wan_traffic_enable  = optional(bool, false)
    circuits            = any
  })
  default = null
}
